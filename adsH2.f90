...
!call help()
open (unit=8885, file = 'Gas-Data', status='old', action = 'read', iostat = ierror)
read(8885,*,iostat = ierror)
read(8885,*,iostat = ierror) M
close(8885)
...
!read the # of freq in Reactan-1 file
...
write (*,950)
   950 format(//,1X,"This code is written  by Mehdi Zare in 6/4/2018 for calculating reaction properties of " ,&
                ...
                //," It is written for reaction A2(g)+2*<==>A*+A*",&
